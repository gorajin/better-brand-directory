...
// Use the same credentials as lib/supabase.ts
const supabaseUrl = 'https://jszdvvdnrflwgtqqstnr.supabase.co';
const supabaseKey = 'sb_publishable_GO0xJ0AtMDEl2FYtuNztBQ_EnnCwFwY';
...
async function seed() {
    ...
    // Insert all brands (upsert to handle duplicates)
